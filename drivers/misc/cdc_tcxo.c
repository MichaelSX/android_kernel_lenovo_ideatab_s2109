				...
				const struct i2c_device_id *id)
{
	...
	cdc_info.active = 1;
	ret = cdc_tcxo_set_req_prio(CDC_TCXO_CLK1, CDC_TCXO_PRIO_REQ);
	dev_err(cdc_info.dev, "CDC_TCXO_CLK1 to CDC_TCXO_PRIO_REQ: %d\n", ret);
	ret = cdc_tcxo_set_req_prio(CDC_TCXO_CLK4, CDC_TCXO_PRIO_REQ);
	dev_err(cdc_info.dev, "CDC_TCXO_CLK4 to CDC_TCXO_PRIO_REQ: %d\n", ret);
