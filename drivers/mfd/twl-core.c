...
/* SW5, PinyCHWu, 20111125, Add for external gpio power key, { */
		child = add_child(1, "fih_twl6030_pwrbutton",
				pdata->ext_pwrbutton, sizeof(*pdata->ext_pwrbutton), true, pdata->irq_base, 0);
//original		child = add_child(1, "twl6030_pwrbutton",
//original			NULL, 0, true, pdata->irq_base, 0);
