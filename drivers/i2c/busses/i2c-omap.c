			     ...
			     struct i2c_msg *msg, int stop)
{
	...
	if (r == 0) {
		...
		if(strcmp(dev_name(dev->dev), "omap_i2c.2") == 0 && !touch_reset_flag)
		{
		         printk("HCLai debug:%s, touch_reset_flag:%d\n", dev_name(dev->dev), touch_reset_flag);
		         // Force reset Touch
                         touch_reset_flag = 1;
