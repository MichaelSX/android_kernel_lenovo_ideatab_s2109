...
/* SW5, PinyCHWu, 20111118, add for prcm control, { */
#include <plat/prcm.h>
/* }, SW5, PinyCHWu, 20111118 */
...
#define GPIO_WIFI_PMENA		46//54
#define GPIO_WIFI_IRQ		43//53
...
static int plat_wlink_kim_suspend(struct platform_device *pdev, pm_message_t
		state)
{
	printk("WeiChu plat_wlink_kim_suspend\n");
	return 0;
}

static int plat_wlink_kim_resume(struct platform_device *pdev)
{
	printk("WeiChu plat_wlink_kim_resume\n");
	return 0;
}
...
#endif
//20120223@WinCYPeng add for TI Patch for support 500mA current
	.power			= 500,
//20120223@WinCYPeng add for TI Patch for support 500mA current
};
...
static struct omap2_hsmmc_info mmc[] = {
	...
	},
	{
		...
		.caps		= MMC_CAP_4_BIT_DATA | MMC_CAP_8_BIT_DATA |
					MMC_CAP_1_8V_DDR,
		.gpio_wp	= -EINVAL,
		// BokeeLi, Fix SD cannot recognize problem due to gpio used by charging
		.gpio_cd	= -EINVAL,
		// BokeeLi, Fix SD cannot recognize problem due to gpio used by charging
	},
	{
...
static struct regulator_consumer_supply tablet_cam2_supply[] = {
	{
		.supply = "cam2pwr",
	},
};
...
static struct regulator_init_data tablet_vaux3 = {
	...
	//SW4-L1-HL-Camera-FTM-ICS-00+{_20111205
	.num_consumer_supplies = 1,
	.consumer_supplies = tablet_cam2_supply,
	//SW4-L1-HL-Camera-FTM-ICS-00+}_20111205
};
...
static int __init omap4_i2c_init(void)
{
	...
	fih_parse_twldata(&tablet_twldata);
#endif
	...
	omap2_i2c_pullup(1, I2C_PULLUP_STD_860_OM_FAST_500_OM);
	omap2_i2c_pullup(2, I2C_PULLUP_STD_2K1_FAST_920OM);
	omap2_i2c_pullup(4, I2C_PULLUP_STD_2K1_FAST_920OM);
	sr_i2c_pullup_set();
...
static void __init omap_tablet_init(void)
{
	...
	pr_info("Before initialize_fih_projects() in tablet board-44xx-tablet.c file");
	initialize_fih_projects();
	pr_info("End initialize_fih_projects() in tablet board-44xx-tablet.c file");
