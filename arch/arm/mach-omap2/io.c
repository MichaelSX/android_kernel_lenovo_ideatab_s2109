...
#include <linux/bootmem.h>	//SW4-L1-HL-Camera-FTM-00+
...
{
	printk("[HL]%s: +++---, return omap_cam_phys_mempool_base\n", __func__);
...
{
	printk("[HL]%s: +++---, return CONFIG_OMAP_ISS_MEM_SIZE * SZ_1M\n", __func__);
...
#endif
	//printk("[HL]%s: omap_cam_reserve_sdram()\n", __func__);
	//omap_cam_reserve_sdram();	//SW4-L1-HL-Camera-FTM-ICS-00+_20120109
}
