...
static ssize_t omap4_key_type_show(struct kobject *kobj,
				 struct kobj_attribute *attr, char *buf)
{
	
	int val;
	u32 val1[8];
	u32 MPK[8]={0x8fdf1e35,0x509d734d,0x6d9a44f7,0x3d983d3d,0x48972062,0xc739f036,0x22e7da52,0x5599b16b};
	
	val &= OMAP2_DEVICETYPE_MASK;
	val >>= 8;
	val1[0] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK);
	val1[1] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+4);
	val1[2] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+8);
	val1[3] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+12);
	val1[4] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+16);
	val1[5] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+20);
	val1[6] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+24);
	val1[7] = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STATUS_MPK+28);
				
	if(val1[0]==MPK[0]&&val1[1]==MPK[1]&&val1[2]==MPK[2]&&val1[3]==MPK[3]&&val1[4]==MPK[4]&&val1[5]==MPK[5]&&val1[6]==MPK[6]&&val1[7]==MPK[7])
		val=0;//hs
	else
		val=1;//fih
...
static OMAP4_SOC_ATTR_RO(key_type, omap4_key_type_show);
...
static struct attribute *omap4_soc_prop_attrs[] = {
	...
	&omap4_soc_prop_attr_key_type.attr,
	NULL,
};
