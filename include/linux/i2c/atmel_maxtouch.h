...
#define MXT_SPT_SELFTEST_T25                      25
#define MXT_SPT_CTECONFIG_T28                     28
#define MXT_SPT_USER_INFO_T38                     38
...
#define MXT_NONTOUCH_MSG    5  /* Only non-touch messages can be read from the message buffer (/dev/maXTouch_messages) */
#define MXT_ALL_MSG         6  /* All messages can be read from the message buffer */
...
struct mxt_platform_data 
{
	...
	int min_x;        /* The default reported X range   */
	int min_y;        /* The default reported Y range   */
...
//	int screen_lock;
	...
	struct workqueue_struct *mxt_single_workqueue;
	...
	int wq_samping_interval;
	int irq_samping_interval;
