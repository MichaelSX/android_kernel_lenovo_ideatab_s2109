...
#define FT5X0X_FIRST_ID_ADDR 0x5       // The first ID register address
#define FT5X0X_POINTER_INTERVAL 0x6    // A group consist of 6 registers
...
enum ft5x0x_ts_regs {
    ...
    FT5X0X_REG_FT5201ID = 0xA8,     /* CTPM Vendor ID */
