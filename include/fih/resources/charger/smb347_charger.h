...
#define SMB347_STATUS_NUM	5
#define SMB347_INT_STATUS_NUM	6
#define SMB347_ALL_STATUS_NUM	11
...
/* Reg SMB347_SYSOK_SEL [7:6] inok/sysok/chgdet mode */
#define SMB347_NONE_MODE	(0)
#define SMB347_INOK_MODE	(1)
#define SMB347_SYSOK_MODE_A	(2)
#define SMB347_SYSOK_MODE_B	(3)
#define SMB347_CHG_DET_MODE	(4)
// Reg SMB347_STAT_CNTL [6] stat mode
#define SMB347_IND_CHG_MODE	(5)
#define SMB347_USB_FAIL_MODE	(6)
// Reg SMB347_VAR_FUNC [7] susp control mode
#define SMB347_SUSP_REG_MODE	(7)
#define SMB347_SUSP_PIN_MODE	(8)
// Reg SMB347_PIN_CNTRL [4] usb control mode
#define SMB347_USB_REG_MODE	(9)
#define SMB347_USB_PIN_MODE	(10)

/* APSD result define */
#define SMB347_APSD_NOT_RUN	(0)
#define SMB347_APSD_CDP		(1)
#define SMB347_APSD_DCP		(2)
#define SMB347_APSD_OTHER_CHG	(3)
#define SMB347_APSD_SDP		(4)
#define SMB347_APSD_ACA		(5)
#define SMB347_APSD_TBD1	(6)
#define SMB347_APSD_TBD2	(7)

/* charging mode definition */
#define SMB347_NO_CHARGING	(0)
#define SMB347_PRE_CHARGING	(1)
#define SMB347_FAST_CHARGING	(2)
#define SMB347_TAPER_CHARGING	(3)
...
#define SMB347_BSTR_GPIO_MASK	(1 << 4)
/* Note! non-used gpio need to set -1 */
...
struct smb347_chip {
	...
	union {
		...
		unsigned char		sts_bytes[SMB347_STATUS_NUM];
	} status;
